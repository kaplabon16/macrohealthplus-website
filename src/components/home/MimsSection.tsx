...
export default function MimsSection() {
  return (
    <Section className="overflow-hidden">
      <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
        <motion.div initial={{ opacity: 0, x: -32 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.01 }} transition={{ duration: 0.75, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <p className="mt-4 text-[15px] leading-7 text-slate-300 sm:mt-6 sm:text-base sm:leading-8 md:text-lg">
        ...
        <motion.div className="relative min-h-[340px] sm:min-h-[420px] lg:min-h-[540px]" initial={{ opacity: 0, x: 38 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.01 }} transition={{ duration: 0.85, ease: [0.22, 1, 0.36, 1] }}>
