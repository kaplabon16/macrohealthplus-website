...
export const clientLogos: ClientLogo[] = [
  ...
  { clientName: 'Bangladesh Medical University ENT Department', logoPath: '/assets/clients/processed/016-bangladesh-medical-university.png', sourceType: 'image', originalFile: 'User-provided Bangladesh Medical University logo', altText: 'Bangladesh Medical University ENT Department logo', notes: 'User-provided BMU logo normalized to the shared transparent logo canvas.' },
  { clientName: 'Bangladesh Medical University Hematology Department', logoPath: '/assets/clients/processed/016-bangladesh-medical-university.png', sourceType: 'image', originalFile: 'User-provided Bangladesh Medical University logo', altText: 'Bangladesh Medical University Hematology Department logo', notes: 'User-provided BMU logo normalized to the shared transparent logo canvas.' },
  { clientName: 'Prime Diagnostic Center', logoPath: '/assets/clients/processed/008-prime-diagnostic-center.png', sourceType: 'docx', originalFile: 'logo.docx / word/media/image8.jpeg', altText: 'Prime Diagnostic Center logo', notes: 'Extracted from DOCX, isolated from its white backplate, and normalized to a transparent logo canvas.' },
