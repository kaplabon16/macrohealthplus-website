...
export const clientLogos: ClientLogo[] = [
  ...
  { clientName: 'Minerva', logoPath: '/assets/clients/processed/015-minerva.png', sourceType: 'image', originalFile: 'User-provided Minerva logo image', altText: 'Minerva logo', notes: 'Background removed and normalized as a transparent PNG for the healthcare-network animation.' },
];
