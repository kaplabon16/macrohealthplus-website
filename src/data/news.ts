...
export const newsItems: NewsItem[] = [
  {
    ...
    homeImage: '/assets/mobile_app_released/mobile_app_released.webp',
    homeImageAlt: 'Dr. Aminur Rahman presenting the MacroHealthPlus mobile prescription app',
    leadImage: '/assets/mobile_app_released/greatdoc_launch_team.webp',
    leadImageAlt: 'MacroHealthPlus team members presenting the GreatDoc mobile app release',
    productImage: '/assets/mobile_app_released/mobile_app_image.webp',
