...
export default function WhyChooseUs() {
  ...
  return (
    <>
      <Section className="pt-24 sm:pt-28 lg:pt-32" eyebrow="Why MacroHealthPlus" title="Technology that respects how healthcare work actually happens" intro="The platform is designed to strengthen continuity between people, records, services, and decisions without forcing every role into the same interface.">
        <motion.ul
